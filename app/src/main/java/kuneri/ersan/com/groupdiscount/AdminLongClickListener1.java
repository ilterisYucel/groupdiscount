...
public class AdminLongClickListener1 implements View.OnLongClickListener{
    ...
    public boolean onLongClick(View view) {
        ...
        new AlertDialog.Builder(context).setTitle("User Record")
                .setItems(items, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int item) {
                        if (item == 1) {
                            ...
                            ((AdminActivity) context).countRecords();
                            ((AdminActivity) context).readRecords1("newest");
